...
const fullText = '404: даже AI не всесилен...'
...
<template>
  <div class="not-found">
    ...
    <p class="subtitle" :class="{ visible: typingComplete }">
      Похоже, эта страница ушла изучать программирование с AI — пока найти её не удалось
    </p>
    ...
    <div class="search-hint" :class="{ visible: typingComplete }">
      <p>💡 Нажмите <kbd>Ctrl</kbd> + <kbd>K</kbd>, чтобы найти нужное содержимое</p>
    </div>
...
<span class="hint">Hint: страница могла быть перемещена или удалена</span></code></pre>
    </div>
  </div>
</template>
